...
#### Management Groups
***
- Management groups allow you to create a top down governance, so that subscriptions below have the rules applied. You can also nest management groups so that rules can be applied to multiple groups more granularly. 
